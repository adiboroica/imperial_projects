...
import classes from './NarrativeOptions.module.css';
  ...
  ****************************************************************/
  ...
  const AddActionNumberInput = () => {
    const onChange = (value: string | number) => {
      if (typeof value === 'number') dispatch(setNumActionsToAdd(value));
    };
  ...
  const GenerateManyDepthInput = () => {
    const onChange = (value: string | number) => {
      if (typeof value === 'number') dispatch(setGenerateManyDepth(value));
    };
