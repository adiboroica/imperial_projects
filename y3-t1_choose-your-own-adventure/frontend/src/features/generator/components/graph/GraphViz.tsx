...
import { IconInfoCircle, IconLayoutAlignLeft, IconLayoutAlignTop } from '@tabler/icons-react';
import {
  memo, useCallback, useMemo,
  useState
} from "react";
import {
  ReactFlow, Connection, ConnectionLineType, Edge, Node, Panel, ReactFlowProvider, useReactFlow
} from '@xyflow/react';
...
const MANTINE_BLUE = "#238be6";
import ActionFlowNode from './FlowNodeAction';
import NarrativeFlowNode from './FlowNodeNarrative';
import { getGraphNodesAndEdges } from './graphLayout';
import './GraphViz.css';
  ...
  const InformationDisplay = () => {
    return (
      <Popover position="bottom" withArrow shadow="md">
        <Popover.Target>
          <UnstyledButton>
            <IconInfoCircle size={32} color={MANTINE_BLUE} />
          </UnstyledButton>
        </Popover.Target>
