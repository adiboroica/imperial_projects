  ...
  Widget build(BuildContext context) {
    return Column(
      children: [
        ...
        ListTile(leading: const Icon(Icons.access_time), title: const Text('Start Time', style: _titleStyle), subtitle: Text(formatTime(event.startTime))),
        ListTile(leading: const Icon(Icons.access_time), title: const Text('End Time', style: _titleStyle), subtitle: Text(formatTime(event.endTime))),
